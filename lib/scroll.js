    ...
    return {
        control: function(page, conf) {
            var scrollBar,
                ...
                startTime,
                handleScroll = conf.callback || function() {},
                scrollPosition = 0,
                ...
                scrollBarConf = {
                    minHeight: '10px',
                    hideDelay: 1000,
                    mode: conf.scrollBarMode || 0 // 0: hidden, 1: autoShow, 2: alwaysShow
                },
                ...
                ScrollHelp = {
                    ...
                    setTranslate: function(id, el, d, chc, r) {
                        ...
                        if (ifRequestAnimationFrame) {
                            requestAnimationFrame((function(_el, _t, _chc) {
                                return function() {
                                    ScrollHelp._setT(_el, _t, _chc);
                                };
                            })(el, t, chc));
                        } else {
                            ScrollHelp._setT(el, t, chc);
                        }
