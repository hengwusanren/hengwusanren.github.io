    ...
    return {
        control: function(page, callback) {
                ...
                ScrollHelp = {
                    ...
                    getScrollBar: function() {
                        ...
                        if(!b || !b.length) {
                            ...
                            f.setAttribute('style', 'position: absolute;top: 0;right: 0;width: 8px;height: 100%;background-color: #ccc;z-index: 100;opacity: 0.8;' + (scrollBarConf.autoHide ? 'display: none;' : ''));
                            ...
                            b.addEventListener('touchmove', function(e) {
                                if(this.parentNode && this.clientHeight >= this.parentNode.clientHeight) {
                                    return;
                                }
                                var touchobj = e.changedTouches[0];
                                ...
                                ScrollHelp.setTranslate(page, -page.clientHeight * (newY / this.parentNode.clientHeight), ScrollHelp.choice);
                    ...
                    getMaxTranslate: function(el, r) {
                        return ((el.parentNode ? el.parentNode.clientHeight : 0) - el.clientHeight);
                    },
            ...
            page.addEventListener('touchstart', function(e) {
                ...
                if(this.parentNode && this.parentNode.clientHeight) {
                    ...
                    b.style.height = this.parentNode.clientHeight / this.clientHeight * 100 + '%';
            ...
            page.addEventListener('touchmove', function(e) {
                ...
                if(this.parentNode && this.parentNode.clientHeight) {
                    var b = ScrollHelp.getScrollBar();
                    b.style.height = this.parentNode.clientHeight / this.clientHeight * 100 + '%';
                    ScrollHelp.setTranslate(b, -b.parentNode.clientHeight * (newY / this.clientHeight), ScrollHelp.choice, true);
                    // console.log(-b.parentNode.clientHeight * (newY / this.clientHeight))
                }
            ...
            page.addEventListener('touchend', function(e) {
                ...
                if(this.parentNode && this.parentNode.clientHeight) {
                    ...
                    ScrollHelp.setTranslate(b, -curPosition / this.clientHeight * b.parentNode.clientHeight, ScrollHelp.choice, true);
                    if(scrollBarConf.autoHide) {
                        scrollBarData.hideTimeout = window.setTimeout(function() {
                ...
                // window.setTimeout(function(that) {
                    // return function() {
                        // handleScroll(that, scrollDir, totalDistX, totalDistY, elapsedTime, distXIntervals, distYIntervals, timeIntervals, curPosition, transBoundary);
                    // };
                // }(this), transResult.time * 1000);
