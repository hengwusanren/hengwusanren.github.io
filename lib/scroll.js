                ...
                ScrollHelp = {
                    ...
                    getScrollBar: function() {
                        ...
                        if(!b || !b.length) {
                            ...
                            f.setAttribute('style', 'position: absolute;top: 0;right: 0;width: 8px;height: 100%;background-color: #ccc;z-index: 100;opacity: 0.6;');
                            b.setAttribute('style', 'position: relative;top: 0;right: 0;background-color: #666;width: 100%;height: 40px;');
                            f.appendChild(b);
                            p.appendChild(f);
