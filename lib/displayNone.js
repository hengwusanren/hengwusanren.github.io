define(function () {
    var _list = null,
        _conf = {
            ...
            _liveRangeOffset: 0,
            get liveRangeOffset() {
                if(_conf._liveRangeOffset) return _conf._liveRangeOffset;
                _conf._liveRangeOffset = Math.ceil(_conf.screenMaxHeight / _cache.minHeight * _conf.liveRatio);
                return _conf._liveRangeOffset;
            },
            _liveRange: 0,
            get liveRange() {
                if(_conf._liveRange) return _conf._liveRange;
                _conf._liveRange = Math.ceil(_conf.screenMaxHeight / _cache.minHeight * (1 + _conf.liveRatio));
                return _conf._liveRange;
            },
            liveRatio: 4,
            displayNeeded: false,
